      ...
      <div className="text-center">
        <div className="flex flex-col gap-5 my-10">
          ...
          <h2 className="text-5xl font-bold">
            Search Apply & <br />
            Get Your <span className="text-[#0f0bdf]">Dream Job</span>
          </h2>
          <p>
            Discover thousands of opportunities tailored for you. Apply with ease and take the next step in your career today.
          </p>
